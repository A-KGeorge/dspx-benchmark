...
|------------|----------------|----------------|------------|-----------|
| small | 0.395 | 0.338 | 5.88 KB | ⚠️ |
| medium | 0.319 | 0.199 | 5.90 KB | ⚠️ |
| large | 0.320 | 0.283 | 5.80 KB | ⚠️ |

**Performance Metrics:**
- Average save time: **0.345 ms**
- Average load time: **0.273 ms**
- Average state size: **5.86 KB**
