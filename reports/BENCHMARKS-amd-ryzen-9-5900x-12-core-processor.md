...
|------------|----------------|----------------|------------|-----------|
| small | 0.065 | 0.209 | 4.15 KB | ✅ |
| medium | 0.059 | 0.310 | 4.17 KB | ✅ |
| large | 0.060 | 0.228 | 4.06 KB | ✅ |

**Performance Metrics:**
- Average save time: **0.061 ms**
- Average load time: **0.249 ms**
