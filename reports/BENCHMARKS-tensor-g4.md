...
- 🔒 **No memory leaks** detected (-2.5933333333333333KB avg growth/iter)
...
|------------|----------------|----------------|------------|-----------|
| small | 0.441 | 1.020 | 4.12 KB | ⚠️ |
| medium | 0.299 | 1.061 | 4.15 KB | ⚠️ |
| large | 0.469 | 0.767 | 4.14 KB | ⚠️ |

**Performance Metrics:**
- Average save time: **0.403 ms**
- Average load time: **0.949 ms**
...
![Latency Distribution Threaded](../charts/tensor-g4/latency_distribution_threaded.png)
